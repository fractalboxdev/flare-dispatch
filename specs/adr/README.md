...
| [0004](./0004-gitlab-scm-adapter.md) | proposed | A provider-neutral `Scm` port (fetchDiff/postReview/updateReview) backs the GitLab merge-request adapter; note-only output, no approvals or statuses |
