// @fractalboxdev/flare-dispatch-gitlab-app — public API.
//
...
//   * `postMergeRequestNote`  — post the visible review comment, returning its id.
//   * `updateMergeRequestNote` — replace an existing note's body in place.
//
// Provider-neutral fetch code: plain typed `async` functions, no Effect
// dependency. The Effect Layer (`makeGitlabScmLive` in
// @fractalboxdev/flare-dispatch-runtime-cf) wraps these onto the neutral `Scm` Tag.
//
...
export {
  ...
  type FetchMergeRequestDiffResult,
