...
<CardGrid>
  <LinkCard title="Offload a job" href="/docs/actions/flare-dispatch-action/" description="Dispatch a run from a GitHub Actions step and gate on its check-run." />
  <LinkCard title="Deploy a Dispatcher" href="/docs/actions/deploy-dispatcher-action/" description="Ship the Worker into your own account from an operator overlay." />
  <LinkCard title="Run catalog" href="/docs/runs/" description="The runs a Dispatcher registers, their inputs, and where their logs live." />
  <LinkCard title="Substrate" href="/docs/substrate/" description="The execution environment for agentic work, consumed through a service-binding facade." />
</CardGrid>
